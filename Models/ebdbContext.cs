...
namespace IntexMummy11.Models
{
    public partial class ebdbContext : DbContext
    {
        ...
        public virtual DbSet<Megatable> Megatable { get; set; }
        public virtual DbSet<Minitable> Data { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Minitable>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("minitable");
